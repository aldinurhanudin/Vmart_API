...
<div class="row">
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-aqua">
        <div class="inner">
          <h3><?php echo e($jumlah_data_buku); ?></h3>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-green">
        <div class="inner">
          <h3><?php echo e($jumlah_data_user); ?><sup style="font-size: 20px"></sup></h3>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
          <div class="inner">
            <h3><?php echo e($jumlah_data_pinjam); ?><sup style="font-size: 20px"></sup></h3>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-yellow">
        <div class="inner">
          <h3><?php echo e($jumlah_data_anggota); ?></h3>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-red">
        <div class="inner">
          <h3><?php echo e($jumlah_data_transaksi); ?></h3>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-red">
        <div class="inner">
          <h3>Rp.<?php echo e($jumlah_data_denda); ?>,-</h3>
...
<?php echo $__env->make('Layout.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asus\Desktop\proyek_3\perpustakaan-app_web\resources\views/v_home.blade.php ENDPATH**/ ?>